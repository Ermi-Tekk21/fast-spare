...
const SearchForm = ({query}: {query?: string}) => {
    return (
        <Form action="/view-proformas" className="relative search-form flex items-center  justify-center w-2/3">
            <input name="query"  defaultValue={query} placeholder="search by customer name or plate no" className="pl-8 border-2 border-slate-800 rounded-full focus:ring-0 font-light h-12 w-full" />
